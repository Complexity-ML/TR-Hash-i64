"""
tr-hash-i64 :: Admin Handlers Mixin
...
class AdminMixin:
    ...
    def _public_model_metadata(self) -> dict:
        ...
        metadata["parameter_count"] = int(
            getattr(
                model,
                "_tr_hash_i64_parameter_count",
                sum(parameter.numel() for parameter in model.parameters()),
            )
        )
        metadata["quantization"] = str(
            getattr(model, "_tr_hash_i64_quantization", "none")
        )
    ...
    async def handle_health(self, request: web.Request) -> web.Response:
        ...
        from tr_hash_i64 import __version__
    ...
    async def handle_openapi(self, request: web.Request) -> web.Response:
        ...
        return web.json_response({
            "openapi": "3.0.3",
            "info": {"title": "tr-hash-i64 API", "version": "0.1.0",
