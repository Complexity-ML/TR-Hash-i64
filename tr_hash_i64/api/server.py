"""
tr-hash-i64 :: API Server (aiohttp)
...
from tr_hash_i64.api.middleware import (
...
from tr_hash_i64.api.events import EventBus
...
from tr_hash_i64.api.types import CompletionRequest, CompletionResponse  # noqa: F401 (re-export)
from tr_hash_i64.api._helpers import HelpersMixin
from tr_hash_i64.api._completions import CompletionsMixin
from tr_hash_i64.api._admin import AdminMixin
from tr_hash_i64.api._rag import RAGMixin
from tr_hash_i64.api._agent import AgentMixin
...
class I64Server(HelpersMixin, CompletionsMixin, AdminMixin, RAGMixin, AgentMixin):
    ...
    def __init__(
        ...
        if engine is None:
            ...
            from tr_hash_i64.cpu.engine import CPUEngine, AsyncCPUEngine
        ...
        # Do not alter checkpoint logits with tokenizer heuristics. Special-token
        # handling and generation termination are controlled by the model config.
        ...
        if rag_index_path:
            try:
                import os
                from tr_hash_i64.rag import Retriever
        ...
        if sandbox_enabled:
            from tr_hash_i64.sandbox import Sandbox
