...
from tr_hash_i64.engine.i64_scheduler import I64Scheduler, I64Batch, I64Request, RequestStatus
...
logger = get_logger("tr_hash_i64.engine")
...
class I64Engine:
    ...
    def _init_kv_cache(self, max_seqs: int):
        ...
        from tr_hash_i64.parallel.tensor_parallel import get_tp
    ...
    def enable_metrics(self, port: int = 9090, model_name: str = ""):
        ...
        from tr_hash_i64.core.metrics import I64Metrics
    ...
    def enable_lora(self, target_names: Optional[List[str]] = None):
        ...
        from tr_hash_i64.layers.lora import LoRAManager
        ...
        if has_custom:
            ...
            for i, rid in complex_indices:
                ...
                if rid in self._request_processors:
                    from tr_hash_i64.core.logits_processor import apply_logits_processors
