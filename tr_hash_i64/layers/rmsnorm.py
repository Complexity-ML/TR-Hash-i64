...
class RMSNorm(nn.Module):
    ...
    def _try_fused_quant(self, x: torch.Tensor):
        ...
        try:
            from tr_hash_i64.kernels.triton.I64_fused_rmsnorm_quant import triton_fused_rmsnorm_quant
    ...
    def _try_gpu_rmsnorm(self, x: torch.Tensor) -> torch.Tensor:
        ...
        try:
            from tr_hash_i64.kernels.triton.I64_fused_rmsnorm_quant import triton_fused_rmsnorm
