...
class DenseMLP(nn.Module):
    ...
    def forward(self, x: torch.Tensor, x_preq=None, **kwargs) -> torch.Tensor:
        ...
        **kwargs absorbs token_ids, expert_ids, mu — dense ignores all routing args.
        ...
        if gate.is_cuda:
            try:
                from tr_hash_i64.kernels.triton.I64_fused_silu_mul import triton_fused_silu_mul
    ...
    def _forward_fp8(self, x: torch.Tensor) -> torch.Tensor:
        ...
        from tr_hash_i64.core.fp8 import fp8_linear
    ...
    def _forward_int8_fused(self, x: torch.Tensor, x_preq=None) -> torch.Tensor:
        ...
        from tr_hash_i64.core.quantization import int8_fused_gate_up_native, int8_linear_native
        from tr_hash_i64.layers.moe import silu_multiply_integer
    ...
    def _forward_int8(self, x: torch.Tensor, x_preq=None) -> torch.Tensor:
        ...
        from tr_hash_i64.core.quantization import int8_linear_native
        from tr_hash_i64.layers.moe import silu_multiply_integer
    ...
    def _forward_int4(self, x: torch.Tensor) -> torch.Tensor:
        ...
        from tr_hash_i64.core.quantization import int4_linear
