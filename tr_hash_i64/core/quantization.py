...
_logger = logging.getLogger("tr_hash_i64.quantization")
...
def int8_linear_native(
    ...
    if x.is_cuda:
        ...
        try:
            from tr_hash_i64.kernels.triton.I64_int8_gemm import triton_int8_gemm
            if x_preq is not None:
                x_int8, x_scale = x_preq[0], x_preq[1]
            else:
                x_int8, x_scale = quantize_activations_int8(x_2d)
        ...
        try:
            from tr_hash_i64.kernels.triton.I64_fused_dequant_gemm import triton_dequant_gemm_int8
