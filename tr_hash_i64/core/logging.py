"""
tr-hash-i64 :: Structured Logging
...
def setup_logging(
    ...
    """
    Configure structured logging for tr-hash-i64.
    ...
    """
    logger = logging.getLogger("tr_hash_i64")
...
def get_logger(name: str = "tr_hash_i64") -> logging.Logger:
