"""
tr-hash-i64 :: Agentics — LLM Client
...
_logger = logging.getLogger("tr_hash_i64.agentics.client")
...
class I64Client:
    """HTTP client for a local tr-hash-i64 server."""
    ...
    def _post(self, endpoint: str, body: dict, timeout: int = 120) -> dict:
        ...
        try:
            ...
            raise ConnectionError(f"Cannot reach tr-hash-i64 server at {self.base_url}") from e
