"""
tr-hash-i64 :: Agentics — ReAct Agent
...
_logger = logging.getLogger("tr_hash_i64.agentics.agent")
...
class Agent:
    ...
    Uses the tr-hash-i64 server's tool_calls support for structured output,
