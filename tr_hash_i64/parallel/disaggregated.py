"""
tr-hash-i64 :: Disaggregated Prefill/Decode
...
logger = get_logger("tr_hash_i64.parallel.disaggregated")
...
class DecodeWorker:
    ...
    def __init__(
        ...
        from tr_hash_i64.engine.i64_scheduler import I64Scheduler, I64Request, RequestStatus
        from tr_hash_i64.core.sampling import SamplingParams, sample_batch
    ...
    def receive_and_add_request(self) -> Optional[int]:
        ...
        from tr_hash_i64.engine.i64_scheduler import I64Request, RequestStatus
        req = I64Request(
            request_id=request_id,
    ...
    def decode_step(self) -> Dict[int, int]:
        ...
        """
        from tr_hash_i64.engine.i64_scheduler import RequestStatus
        from tr_hash_i64.core.sampling import SamplingParams, sample_batch
...
def launch_disaggregated(tp_size: int, args: list) -> int:
    ...
    import subprocess
    import sys
    from tr_hash_i64.parallel.launcher import _find_free_port
    ...
    env["TR_HASH_I64_DISAGGREGATED"] = "1"
