"""
tr-hash-i64 :: I64 CUDA Kernel Loader
...
Usage:
    from tr_hash_i64.kernels.cuda import get_i64_cuda_ops, is_i64_cuda_available
...
logger = get_logger("tr_hash_i64.kernels.cuda")
