...
Usage:
    from tr_hash_i64.kernels.kernel_loader import get_ops
...
logger = get_logger("tr_hash_i64.kernels")
...
class FallbackOps:
    ...
    def scatter_by_expert(hidden, expert_ids, num_experts):
        from tr_hash_i64.kernels.i64_ops import i64_scatter
        return i64_scatter(hidden, expert_ids, num_experts)

    @staticmethod
    def gather_by_expert(expert_out, scatter_indices):
        from tr_hash_i64.kernels.i64_ops import i64_gather
    ...
    def fused_route_scatter(token_ids, hidden, num_experts):
        ...
        from tr_hash_i64.kernels.i64_ops import i64_route_tokens, i64_scatter
